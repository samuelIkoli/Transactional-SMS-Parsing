...
// MAIN CONTROLLER
export const parseMessage: RequestHandler = async (req: Request, res: Response) => {
    ...
    try {
        ...
        parsedData.institution = senderID.length > 4 ? senderID.replace(/([A-Z])/g, ' $1').trim() : senderID        
